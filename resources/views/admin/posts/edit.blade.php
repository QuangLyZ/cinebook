...
<div class="space-y-8 animate-[fadeIn_0.5s_ease-in-out]">
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('admin.posts.edit', $post->id) }}"
           class="inline-flex items-center justify-center w-9 h-9 rounded-xl border border-blue-500/30 bg-blue-500/10 text-blue-300 hover:bg-blue-500/20">
        ...
        <form action="{{ route('admin.posts.destroy', $post->id) }}" method="POST"
            ...
            <button type="submit"
                class="inline-flex items-center justify-center w-9 h-9 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 hover:bg-red-500/20">
